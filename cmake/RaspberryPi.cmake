...
set(PLATFORMS arm-linux-gnueabihf arm-none-gnueabi)

foreach(PLATFORM ${PLATFORMS})
  find_path(RPI_COMPILER ${PLATFORM}-gcc)
  message(${RPI_COMPILER})
  if(RPI_COMPILER)
...
set(CMAKE_EXE_LINKER_FLAGS "-static-libstdc++ -static-libgcc -L${PI_SYS_ROOT}/lib -L${PI_SYS_ROOT}/vc/lib" CACHE STRING "")
